...
function CompanyCell({ row }: { row: RankedRow }) {
  return (
    <Link href={`/stock/${row.symbol}`} className="group flex items-center gap-3">
      ...
      <div className="min-w-0 max-w-[180px]">
        <div className="truncate font-medium text-gray-900 group-hover:text-blue-600 group-hover:underline">
          {row.name}
        </div>
